...
@section('content')
        ...
        <div class=" mx-auto bg-white max-w-lg  p-8 my-10 rounded-lg shadow-2xl mt-28 ">
            <div class="inputs w-full max-w-2xl p-6 mx-auto">
                ...
                <form class="mt-6 border-t border-gray-400 pt-4">
                    ...
                    <div class='w-full md:w-full px-3 mb-6'>
                        <label class='block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2'>Student LRN</label>
                        <input
                            class='appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500'
                            type='text'>
                    </div>
                            ...
                            <div class='w-full md:w-full px-3 mb-6'>
                                ...
                                <div class="flex-shrink w-full inline-block relative">
                                    ...
                                    <div class="flex justify-end">
                                        <button
                                            class="appearance-none bg-gray-200 text-gray-900 mt-6 px-4 py-1 shadow-sm border border-gray-400 rounded-md mr-3"
